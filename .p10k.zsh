# Generated by Powerlevel10k configuration wizard on 2025-12-09 at 16:51 -05.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#2d5b69'
...
typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#ff4e45'
typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#101518' # Icono negro para contraste
typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#d63c35'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
typeset -g POWERLEVEL9K_TIME_BACKGROUND='#101518' # Casi negro
typeset -g POWERLEVEL9K_TIME_FOREGROUND='#ff4e45' # Hora en rojo
